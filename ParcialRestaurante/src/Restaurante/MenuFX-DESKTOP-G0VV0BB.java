...
public class MenuFX extends Application {
    ...
    private GridPane inicializarUI() {
        ...
        ImageView pizzaImageView = new ImageView(new Image("file:C:/Users/ronal/Documents/NetBeansProjects/ParcialRestaurante/src/Restaurante/pizza.jpg"));
        pizzaImageView.setOnMouseClicked(e -> platosComboBox.setValue("Pizza"));
        grid.add(pizzaImageView, 0, 0);

        ImageView hamburguesaImageView = new ImageView(new Image("file:C:/Users/ronal/Documents/NetBeansProjects/ParcialRestaurante/src/Restaurante/hamburgueza.jpg"));
        hamburguesaImageView.setOnMouseClicked(e -> platosComboBox.setValue("Hamburguesa"));
        grid.add(hamburguesaImageView, 1, 0);

        ImageView ensaladaImageView = new ImageView(new Image("file:C:/Users/ronal/Documents/NetBeansProjects/ParcialRestaurante/src/Restaurante/ensalada.jpg"));
